...
// ---------------------------------------------------------------------
// Lunar Silk. A plain weave of two very different yarns: a pale silver
// warp and a deep indigo weft. Because the two yarns run at right angles
// their anisotropic highlights never fire together, so the cloth reads
// silver from one side of the gallery and midnight blue from the other.
// ---------------------------------------------------------------------
