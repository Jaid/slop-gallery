...
type FrameHook = (callback: () => void, options: {phase: 'finish'}) => unknown

export function createEgoTelemetryHook(useFrame: FrameHook) {
  return function useEgoTelemetry(options: EgoTelemetryOptions) {
