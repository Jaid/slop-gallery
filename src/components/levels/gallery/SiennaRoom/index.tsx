...
export default function SiennaRoom({wood}: {wood: Texture}) {
  ...
  return <>
    <group position={[room.center[0], 0, room.center[1]]}>
      ...
      <mesh name="sienna-wood-floor" receiveShadow position={[0, 0.001, 0]} rotation={[-Math.PI / 2, 0, 0]}>
      ...
      <mesh name="sienna-carpet" receiveShadow position={[0, 0.014, 0]} rotation={[-Math.PI / 2, 0, 0]}>
