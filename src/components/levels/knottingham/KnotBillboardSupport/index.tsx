...
export function Sign({face}: {face: Material}) {
  ...
  return <>
    ...
    <CuboidCollider args={[panelPart.size[0] / 2, panelPart.size[1] / 2, panelPart.size[2] / 2]} friction={knotBillboardPhysics.sign.friction} mass={knotBillboardPhysics.sign.mass} position={position} restitution={knotBillboardPhysics.sign.restitution} />
  </>
}
