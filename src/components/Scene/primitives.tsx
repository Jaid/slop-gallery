...
export default function Box({size, color = '#dad2bf', map, material, metalness = 0, roughness = 0.7, envMapIntensity = 1, ...props}: Omit<ThreeElements['mesh'], 'children'> & {color?: string
