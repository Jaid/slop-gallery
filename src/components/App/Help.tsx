...
export default function Help() {
  return <>
    ...
    <div className="help-list">{[
      ...
      ['05', 'Listen. Look. Linger.', 'Right-click or press R to hear a story. Hold V to square up to an artwork. Narration waits for unfinished labels. M toggles all sound. Try viewing The Ambassador from a different angle.'],
      ...
      ['07', 'Read between the rooms', 'The arches lead to two more salons. Sculptures can be picked up and thrown. So can individual plant leaves: hold LMB or press E to pluck one, then right-click or press Q to throw. Esc cancels a pluck. Remove every leaf from a plant to pick up and throw its pot, remaining stems and all. The suspicious book near the rear wall may know something about a fourth room.'],
