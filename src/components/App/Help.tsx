...
export default function Help() {
  return <>
    ...
    <div className="help-list">{[
      ...
      ['07', 'Read between the rooms', 'The arches lead to the side salons. The Amber Room is through the rear arch in the Cabinet of Curiosities. Sculptures can be picked up and thrown. The Antechamber is through the rear doorway. Its east stairway descends to the dim Undertone gallery. The book on its pedestal can be picked up and thrown, too.'],
