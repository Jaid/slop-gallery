...
export default function App() {
  ...
  return <Dropzone>
    ...
    {!s.locked && !s.panel && !s.dragging && !prompt && <div className="exhibit-caption"><span>ON VIEW</span><strong>The art of not making sense.</strong><p>Three salons. One well-kept secret.</p><button onClick={() => openPanel('collection')}>Meet the collection <span>↗</span></button></div>}
    {s.locked && <>
