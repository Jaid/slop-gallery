...
export default function Map() {
  ...
  return <>
    <p className="panel-intro">Nine rooms across the upper and lower galleries. The Oculus’s raised north platform leads through a stone tunnel to the Lodge. The Corridor follows the timber return route from the Lodge to Sienna.</p>
