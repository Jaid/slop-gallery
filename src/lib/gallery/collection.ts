...
export const initialPortraits: Array<Portrait> = [
  ...
  {
    id: 'doge',
    title: 'The Duality of Doge',
    creator: 'Lenticular Labs',
    description: 'From the left, a peaceful velvet pup. Move to the right, and behold a cosmic galactic predator of pure neon fury.',
    source: '/art/doge-velvet.webp',
    alternateSource: '/art/doge-neon.webp',
